...
program
  ...
  .description(
    'Gets or sets the brightness of the backlight on a Litra Beam LX device as a percentage (0-100)',
  )
  .option(
  ...
  .argument(
    '[brightness]',
    'the percentage of the backlight brightness to set, e.g. `80`. If not provided, the current brightness will be returned',
    parseIntOption,
  );
