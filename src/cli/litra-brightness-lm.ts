...
program
  ...
  .description(
    "Manages the brightness of a Litra device. If a brightness argument is provided, it sets the device's brightness to the supplied value in Lumen. If no brightness argument is provided, it returns the current brightness in Lumen.",
  )
  .option(
