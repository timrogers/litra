 ...
 */
export const setBacklightOn = (device) => {
    if (device.type !== DeviceType.LitraBeamLX) {
 ...
 * @throws {Error} If the device is not a Litra Beam LX
 */
export const setBacklightOff = (device) => {
    if (device.type !== DeviceType.LitraBeamLX) {
        throw 'Backlight is only supported on Litra Beam LX devices';
    }
 ...
 * @throws {Error} If the device is not a Litra Beam LX
 */
export const toggleBacklight = (device) => {
 ...
 */
export const setBacklightBrightnessPercentage = (device, brightnessPercentage) => {
    if (device.type !== DeviceType.LitraBeamLX) {
        throw 'Backlight is only supported on Litra Beam LX devices';
    }
    if (brightnessPercentage < 0 || brightnessPercentage > 100) {
 ...
 * @throws {Error} If the device is not a Litra Beam LX
 */
export const getBacklightBrightnessPercentage = (device) => {
    if (device.type !== DeviceType.LitraBeamLX) {
        throw 'Backlight is only supported on Litra Beam LX devices';
    }
